...
class TriggeredSequence:
    ...
    def save_result(self):
        ...
        base_name = f"{self.save_path}/b{timestamp}"
        filenumber = 1
...
def app_wrapper(autosave_flag):
    ts = TriggeredSequence(autosave=autosave_flag)   

    # Emulate camera for testing
